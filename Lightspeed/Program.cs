...
namespace Lightspeed
{
    ...
    public class LightSpeed
    {
        ...
        public async Task<Item> GetItem(int itemId)
        {
            ...
            string API_URL =
                       string.Format("https://api.merchantos.com/API/Account/{0}/Item/{1}.json?callback=", ConfigurationManager.AppSettings["CLIENT_ID"], itemId);
            ...
            var z = tmpNestObject.TryGetIndex(1);
